...
from compute_horde_validator.validator.organic_jobs.facilitator_client import HeartbeatManager
...
class Command(BaseCommand):
    ...
    async def handle(self, *args, **options):
        logger.info(f"Starting facilitator client heartbeat manager")
